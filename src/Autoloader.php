 ...
 *      $config = [ ... ];
 *      $loader = new \Myth\Autoloader\Autoloader($config);
 *
 *      // register the autoloader
 *      $loader->register();
 *
 * @package Myth\Autoloader
 */
class Autoloader {
	...
	/**
	 * Register the loader with the SPL autloader stack.
	 */
	 ...
	 * if possible.
	 *
	 * @param string $class The fully-qualifed class name
